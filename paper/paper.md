...
In previous hackathons, the development of linked data querying tools such as pyBioDatafuse[@citation:gadiya_biohackeu23_2023;@citation:acosta_biohackeu24_2025], a python package for the construction of knowledge graphs from linked and non-linked data, showed that manual authoring of queries for annotators remains the main bottleneck when developing tools that consume linked data.
